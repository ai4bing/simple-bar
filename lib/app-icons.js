...
export const apps = {
  ...
  kitty: Icons.kitty,
  Inkscape: Icons.Inkscape,
  "Cisco Secure Client": Icons.Cisco,
  Wolfram: Icons.Mathematica,
  Filen: Icons.Filen,
  Sorayomi: Icons.Tachiyomi,
  "Tachidesk Sorayomi": Icons.Tachiyomi,
  "Karabiner-Elements": Icons.Karabiner,
  "Karabiner-EventViewer": Icons.Karabiner,
  BetterTouchTool: Icons.BetterTouchTool,
  "Docker Desktop": Icons.Docker,
  Waterfox: Icons.WaterFox,
